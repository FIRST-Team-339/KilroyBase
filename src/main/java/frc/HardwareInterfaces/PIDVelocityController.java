...
public class PIDVelocityController extends PIDSubsystem {
     ...
     * @written 11 Feb 2014
     */
    PIDVelocityController(final MotorController motor, final Encoder encoder, double Kp, double Ki, double Kd) {
     ...
     * @written 11 Feb 2014
     */
    public PIDVelocityController(final MotorController motor, final Encoder encoder, double Kp, double Ki, double Kd,
            double Kf) {
        super(Kp, Ki, Kd);
