...
// -------------------------------------------------------
/**
 * This class is used when we want to use a momentary switch as denoting ON or
 * Off.
 *
...
public class MomentarySwitch
     ...
     * -------------------------------------------------------
     *
     * @description This denotes the previous state of the switch as of the last
     *              time it was either initialized or it was set
     * @author Bob Brown
     * @written Feb 06, 2011
     *          --------------------------------------------------------
     */
     ...
     *          --------------------------------------------------------
     */
    protected boolean previouslyOn = false;
     ...
     * @return int - button number that will be checked to see if the momentary
    ...
    // ---------------------------------------------------------
    /**
     * returns the joystick that holds the button that will be checked
     *
     * @method getJoystick
     * @return Joystick - joystick used to hold the button that will be used to
     *         check to see if the momentary switch has been pushed
     * @author Bob Brown
     * @written Feb 06, 2011
     *          --------------------------------------------------------
     */
    ...
    // ---------------------------------------------------------
    /**
     * sets and returns the joystick that holds the button that will be checked
     *
     * @method getJoystick
     * @return Joystick - joystick used to hold the button that will be used to
     *         check to see if the momentary switch has been pushed
     ...
     * @method update
     * @param presentState
     *            - tells the class what the present state of the state changer
     *            (button) is.
     * @author Bob Brown
     * @written Feb 06, 2011
     *          --------------------------------------------------------
